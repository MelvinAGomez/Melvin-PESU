...
def index():
    ...
    for msg in consumer_2:
        ...
        metrics[i] = {"Test_ID":test_id,"Mean_Latency": mean_latency, "Median_Latency": median_latency, "Min_Latency": min_latency,"Max_Latency": max_latency}
        i += 1
